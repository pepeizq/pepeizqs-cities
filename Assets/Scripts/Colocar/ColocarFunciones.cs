...
public static class ColocarFunciones {
    ...
    {
        if (((edificio.dimensiones.x == 2) && (edificio.dimensiones.y == 1) || (edificio.dimensiones.x == 2) && (edificio.dimensiones.y == 2)))
        {
            if (rotacion == -180)
            {
    ...
    public static Construccion ComprobarPosicion(Construccion[,] edificios, Construccion edificio, Vector3 posicion, int rotacion)
    {
